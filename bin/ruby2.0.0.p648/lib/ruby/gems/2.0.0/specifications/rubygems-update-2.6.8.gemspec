...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/update_rubygems", "CODE_OF_CONDUCT.md", "CONTRIBUTING.rdoc", "CVE-2013-4287.txt", "CVE-2013-4363.txt", "CVE-2015-3900.txt", "History.txt", "LICENSE.txt", "MAINTAINERS.txt", "MIT.txt", "Manifest.txt", "POLICIES.rdoc", "README.rdoc", "UPGRADING.rdoc", "bundler/CHANGELOG.md", "bundler/CODE_OF_CONDUCT.md", "bundler/CONTRIBUTING.md", "bundler/DEVELOPMENT.md", "bundler/ISSUES.md", "bundler/LICENSE.md", "bundler/README.md", "bundler/man/index.txt", "hide_lib_for_update/note.txt"]
