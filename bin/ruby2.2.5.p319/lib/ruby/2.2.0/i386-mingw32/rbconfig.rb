...
module RbConfig
  RUBY_VERSION.start_with?("2.2.5"[/^[0-9]+[.][0-9]+[.]/]) or
    raise "ruby lib version (2.2.5) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.2.5"
